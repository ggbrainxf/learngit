...
void init()
{
    ...
    generateEllipsePoints(circle_vertices,circle_colors,0,CIRCLE_NUM_POINTS,glm::vec2(0.75,0.75),0.2,1.0);
    generateEllipsePoints(ellipse_vertices,ellipse_colors,0,ELLIPSE_NUM_POINTS,glm::vec2(-0.75,0.75),0.2,0.5);
...
int main(int argc, char **argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(512, 512, "2022155010_伍丽薇_实验一", NULL, NULL);
	if (window == NULL)
	{
